...
class Directorys extends CI_Controller {
    ...
    function index(){
        ...
        $data['seo_title']        = ($data['seo_title'] == "") ? "ARDIA PERDANA" : $data['seo_title'];
        $data['meta_description'] = ($data['meta_description'] == '') ? "ARDIA PERDANA" : $data['meta_description'];
        $data['meta_keywords']    = ($data['meta_keywords'] == '') ? "ARDIA PERDANA" : $data['meta_keywords'];
